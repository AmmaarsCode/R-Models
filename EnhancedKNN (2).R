...
setwd("C:/Users/kirsteink/Downloads")
#
...
# Now let's merge the results of our knn classification in nn into our new.df
# By creating a new field called Ownership
#
new.df$Ownership <- nn[1:4]
#
# Look it over
View(new.df)
#
# Now we are going to merge the newly classified rows into the original file
# This expands our ability to better classify data in the future.
# It makes our classification process stronger
# And it helps our "machine" learn
# This is how algorithms or machines learn how to be better
#
mower.df <- rbind(mower.df, new.df)
#
# Let's look at the results
#
View(mower.df)
#
# Let's plot the new mower file
